...
func createAccountTable(stub *shim.ChaincodeStub) error {
...
func addAccount(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
...
func getAccountsQuantity(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	return countTableRows(stub, []string{AccountsTableName})
}

func getAccountsList(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	return filterTableByValue(stub, []string{AccountsTableName})
}

func updateAccountAmount(stub *shim.ChaincodeStub, args []string) ([]byte, error) {
	if len(args) != 2 {
